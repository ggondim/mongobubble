...
describe('MongoRepository', () => {
  ...
  test('insertOne', async () => {
    ...
    const repoResult = await repository.insertOne(user) as UserOid;
  ...
  test('insertMany', async () => {
    ...
    const repoResult = await repository.insertMany([user1, user2]) as UserOid[];
  ...
  test('deleteOne', async () => {
    ...
    const deleteResult = await repository.deleteOne(repoResult);
